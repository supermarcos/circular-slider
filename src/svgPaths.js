import { angleToPosition } from './circularGeometryHelpers';

const getStartAndEndPosition = opts => {
...
const arcPathWithRoundedEnds = opts => {
  ...
  return ''.concat(startPoint, innerArc, firstButt, outerArc, secondButt, ' Z');
};

export { getStartAndEndPosition, pieShapedPath, arcShapedPath, arcPathWithRoundedEnds };
